...
globalkeys = mytable.join(
	...
	end, { description = "toggle mute default input", group = "hotkeys" }),

	-- MPD control
	awful.key({}, "XF86AudioPlay", function()
		os.execute("mpc toggle")
		beautiful.mpd.update()
	end, { description = "MPRIS Play/Pause", group = "Media" }),
	...
	awful.key({}, "XF86AudioNext", function()
		...
		beautiful.mpd.update()
	end, { description = "MPRIS Next", group = "Media" }),
	...
	end, { description = "run music manager", group = "launcher" }),
	awful.key({ modkey, "Shift" }, "e", function()
		awful.spawn(quickedit)
	end, { description = "pop up editor", group = "launcher" }),
	awful.key({ modkey, "Shift" }, "n", function()
		awful.spawn("dmenu-networkmanager")
	end, { description = "network manager", group = "launcher" }),

	-- Edit Configs
	awful.key({ modkey, "Shift" }, "c", function()
		awful.spawn("dmenu-edit-configs")
	end, { description = "edit configs", group = "launcher" }),

	awful.key({ modkey }, "p", function()
		awful.spawn("rofi -mode combi -show drun")
	...
	awful.key({ modkey, "Shift" }, "v", function()
		awful.spawn("dmenu-greenclip")
	end, { description = "clipboard manager", group = "launcher" }),

	-- Dmenu Calc
	awful.key({ modkey, "Shift" }, "=", function()
		awful.spawn("=")
	end, { description = "Calculator", group = "custom" }),

	-- Dmenu virsh list
	awful.key({ modkey, "Shift" }, "i", function()
		awful.spawn("rofi-vbox")
	end, { description = "VirtualBox VMs", group = "launcher" }),
	...
	awful.key({ modkey, "Shift" }, "r", function()
		awful.spawn("dmenu-remmina")
	end, { description = "dmenu remmina connections", group = "launcher" }),

	-- Scrot
	awful.key({ modkey, "Shift" }, "/", function()
		awful.spawn("dmenu-scrot")
	end, { description = "Screen Shot", group = "launcher" }),
	...
	end, { description = "Emacs", group = "applications" }),
	...
	awful.key({ modkey }, "F7", function()
		awful.spawn("dbeaver")
	end, { description = "Database Manager", group = "applications" }),

	-- Virt Manager
	awful.key({ modkey }, "F8", function()
		awful.spawn("virt-manager")
	end, { description = "Virt-Manager", group = "applications" }),
	...
	awful.key({ modkey, "Shift", altkey }, "x", function()
		awful.prompt.run({
			prompt = "Run Lua code: ",
...
awful.rules.rules = {
	...
	-- musicmanager floating centered
	{
		rule = { class = "musicmanager" },
		properties = {
			floating = true,
			placement = awful.placement.centered,
		},
